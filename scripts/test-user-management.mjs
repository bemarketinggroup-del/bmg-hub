...
assert.match(appSource, /apiFetch\("\/api\/users\?include_diagnostics=1", \{[\s\S]*cache: "no-store"/, "il browser non deve riusare risposte precedenti della directory utenti");
