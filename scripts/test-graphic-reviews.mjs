...
assert.match(htmlSource, /id="graphicsDriveScrollHint"/);
...
assert.match(appSource, /function updateGraphicsDriveScrollHint/);
...
assert.match(styleSource, /\.graphics-drive-scroll-hint/);
