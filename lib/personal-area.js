...
export async function personalAreaPayload(profile) {
  ...
  const notifications = filterActiveNotifications(await loadUnreadNotifications(profile.id), activeTasks);
...
export function filterActiveNotifications(notifications, activeTasks) {
